 ...
 if(isset($_REQUEST['assign'])){
  ...
  if(($_REQUEST['request_id'] == "") || ($_REQUEST['request_info'] == "") || ($_REQUEST['requestdesc'] == "")
   || ($_REQUEST['requestername'] == "") || ($_REQUEST['address1'] == "") || ($_REQUEST['address2'] == "")
    || ($_REQUEST['requestercity'] == "") || ($_REQUEST['requesterstate'] == "") || ($_REQUEST['requesterpin'] == "")
   ...
   $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2" role="alert"> Fill All Fileds </div>';
    ...
    $sql = "INSERT INTO assignwork (request_id, request_info, request_desc, requester_name, requester_add1, requester_add2, requester_city, requester_state, requester_pin, requester_email, requester_mobile, assign_tech, assign_date) 
            VALUES ('$rid', '$rinfo','$rdesc', '$rname', '$radd1', '$radd2', '$rcity', '$rstate', '$rpin', '$remail', '$rmobile', '$rassigntech', '$rdate')";
    if($conn->query($sql) == TRUE){
 ...
 <div class="col-sm-5 mt-5 jumbotron">
  ...
  <form action="" method="POST">
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-4">
        <label for="requesterpin">pin</label>
        <input type="text" class="form-control" id="requesterpin" name="requesterpin" value="<?php if(isset($row['requester_pin'])) { echo $row['requester_pin']; } ?>"
