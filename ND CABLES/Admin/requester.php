...
if(isset($_REQUEST['delete'])){
  $sql = "DELETE FROM requester WHERE r_login_id = {$_REQUEST['id']}";
...
<div class='float-right'><a class="btn btn-danger box" href="insertreq.php"><i class="fas fa-plus fa-2x"></i></a>
</div>
</div>
<?php
