<?php
  ...
  if(isset($_REQUEST['rSignup'])){
    ...
    if(($_REQUEST['rName'] == "") || ($_REQUEST['rEmail'] == "") || ($_REQUEST['rPassword'] == "")){
      ...
      $sql = "SELECT r_email FROM requester WHERE r_email='".$_REQUEST['rEmail']."'";
      ...
      if($result->num_rows==1){
        ...
        $sql = "INSERT INTO requester(r_name, r_email, r_password) VALUES ('$rName','$rEmail', '$rPassword')";
    ...
    <div class="col-md-6 offset-md-3">
      <form action="" class="shadow-lg p-4" method="POST">
        <div class="form-group">
          <i class="fas fa-user-circle"></i><label for="name" class="pl-2 font-weight-bold">Name</label><input type="text"
            class="form-control" placeholder="Name" name="rName">
        </div>
        <div class="form-group">
          <i class="fas fa-paper-plane"></i><label for="email" class="pl-2 font-weight-bold">Email</label><input type="email"
