...
if(isset($_REQUEST['submitrequest'])){
 ...
 if(($_REQUEST['requestinfo'] == "") || ($_REQUEST['requestdesc'] == "") || ($_REQUEST['requestername'] == "") || ($_REQUEST['requesteradd1'] == "") || ($_REQUEST['requesteradd2'] == "") || ($_REQUEST['requestercity'] == "") || ($_REQUEST['requesterstate'] == "") || ($_REQUEST['requesterpin'] == "") || ($_REQUEST['requesteremail'] == "") || ($_REQUEST['requestermobile'] == "") || ($_REQUEST['requestdate'] == "")){
  ...
  $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2" role="alert"> Fill All Fileds </div>';
   ...
   $rpin = $_REQUEST['requesterpin'];
   $remail = $_REQUEST['requesteremail'];
   $rmobile = $_REQUEST['requestermobile'];
   $rdate = $_REQUEST['requestdate'];
   $sql = "INSERT INTO submitrequest(request_info, request_desc, requester_name, requester_add1, requester_add2, requester_city, requester_state, requester_pin, requester_email, requester_mobile, request_date) VALUES ('$rinfo','$rdesc', '$rname', '$radd1', '$radd2', '$rcity', '$rstate', '$rpin', '$remail', '$rmobile', '$rdate')";
...
<div class="col-sm-9 col-md-10 mt-5">
  <form class="mx-5" action="" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="inputName" placeholder="xyz" name="requestername">
    </div>
    <div class="form-row">
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-2">
        ...
        <input type="text" class="form-control" id="inputpin" name="requesterpin" onkeypress="isInputNumber(event)">
      </div>
    </div>
