...
if(!isset($_SESSION['is_login'])){
  if(isset($_REQUEST['rEmail'])){
    ...
    $sql = "SELECT r_email, r_password FROM requester WHERE r_email='".$rEmail."' AND r_password='".$rPassword."' limit 1";
...
<body>
  <div class="mb-3 text-center mt-5" style="font-size: 30px;">
    ...
    <span>ND CABLE Service Managment System</span>
  </div>
  <p class="text-center" style="font-size: 20px;"> <i class="fas fa-globe text-danger"></i> <span> ND CABLE </span>
  </p>
